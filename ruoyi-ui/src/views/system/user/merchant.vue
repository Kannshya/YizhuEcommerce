...
<!--              <el-table-column label="用户编号" align="center" key="userId" prop="userId" v-if="columns[0].visible" />-->
              ...
              <el-table-column label="审核状态" align="center" key="status" v-if="columns[5].visible">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="营业执照">
              <image-preview :src="form.businessLicense" :width="200" :height="200"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm('确认要"' + text + '""' + row.userName + '"商户吗?').then(function () {
